...
class CashbackCollectionView: UICollectionView, UICollectionViewDelegateFlowLayout {
    var data = [Cashback]()
...
extension CashbackCollectionView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.price.text = data[indexPath.row].cashback
        return cell
    }
